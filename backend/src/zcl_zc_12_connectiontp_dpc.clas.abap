class ZCL_ZC_12_CONNECTIONTP_DPC definition
  public
...
protected section.
  ...
  methods ZC_09_MEALTP_UPDATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZC_12_CONNECTIONTP_MPC=>TS_ZC_09_MEALTPTYPE
    raising
  ...
  methods ZC_09_MEALTP_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZC_12_CONNECTIONTP_MPC=>TT_ZC_09_MEALTPTYPE
  ...
  methods ZC_09_FLIGHTTP_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZC_12_CONNECTIONTP_MPC=>TS_ZC_09_FLIGHTTPTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZC_09_FLIGHTTP_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZC_12_CONNECTIONTP_MPC=>TT_ZC_09_FLIGHTTPTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods ZC_09_CUSTOMERTP_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZC_12_CONNECTIONTP_MPC=>TS_ZC_09_CUSTOMERTPTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZC_09_CUSTOMERTP_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZC_12_CONNECTIONTP_MPC=>TT_ZC_09_CUSTOMERTPTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods ZC_09_CONNECTION_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZC_12_CONNECTIONTP_MPC=>TS_ZC_09_CONNECTIONTPTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZC_09_CONNECTION_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZC_12_CONNECTIONTP_MPC=>TT_ZC_09_CONNECTIONTPTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods ZC_09_BOOKINGTP_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZC_12_CONNECTIONTP_MPC=>TS_ZC_09_BOOKINGTPTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZC_09_BOOKINGTP_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZC_12_CONNECTIONTP_MPC=>TT_ZC_09_BOOKINGTPTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZC_12_CONNECTIONTP_DPC IMPLEMENTATION.
...
*&* This class has been generated on 14.10.2021 16:52:10 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZC_12_CONNECTIONTP_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA zc_09_bookingtp_create_entity TYPE zcl_zc_12_connectiontp_mpc=>ts_zc_09_bookingtptype.
 DATA zc_09_mealtp_create_entity TYPE zcl_zc_12_connectiontp_mpc=>ts_zc_09_mealtptype.
 DATA zc_09_connection_create_entity TYPE zcl_zc_12_connectiontp_mpc=>ts_zc_09_connectiontptype.
 DATA zc_09_customertp_create_entity TYPE zcl_zc_12_connectiontp_mpc=>ts_zc_09_customertptype.
 DATA zc_09_flighttp_create_entity TYPE zcl_zc_12_connectiontp_mpc=>ts_zc_09_flighttptype.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA zc_09_bookingtp_get_entity TYPE zcl_zc_12_connectiontp_mpc=>ts_zc_09_bookingtptype.
 DATA zc_09_connection_get_entity TYPE zcl_zc_12_connectiontp_mpc=>ts_zc_09_connectiontptype.
 DATA zc_09_customertp_get_entity TYPE zcl_zc_12_connectiontp_mpc=>ts_zc_09_customertptype.
 DATA zc_09_flighttp_get_entity TYPE zcl_zc_12_connectiontp_mpc=>ts_zc_09_flighttptype.
 DATA zc_09_mealtp_get_entity TYPE zcl_zc_12_connectiontp_mpc=>ts_zc_09_mealtptype.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZC_12_CONNECTIONTP_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA zc_09_bookingtp_get_entityset TYPE zcl_zc_12_connectiontp_mpc=>tt_zc_09_bookingtptype.
 DATA zc_09_connection_get_entityset TYPE zcl_zc_12_connectiontp_mpc=>tt_zc_09_connectiontptype.
 DATA zc_09_customertp_get_entityset TYPE zcl_zc_12_connectiontp_mpc=>tt_zc_09_customertptype.
 DATA zc_09_flighttp_get_entityset TYPE zcl_zc_12_connectiontp_mpc=>tt_zc_09_flighttptype.
 DATA zc_09_mealtp_get_entityset TYPE zcl_zc_12_connectiontp_mpc=>tt_zc_09_mealtptype.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA zc_09_mealtp_update_entity TYPE zcl_zc_12_connectiontp_mpc=>ts_zc_09_mealtptype.
 DATA zc_09_flighttp_update_entity TYPE zcl_zc_12_connectiontp_mpc=>ts_zc_09_flighttptype.
 DATA zc_09_customertp_update_entity TYPE zcl_zc_12_connectiontp_mpc=>ts_zc_09_customertptype.
 DATA zc_09_connection_update_entity TYPE zcl_zc_12_connectiontp_mpc=>ts_zc_09_connectiontptype.
 DATA zc_09_bookingtp_update_entity TYPE zcl_zc_12_connectiontp_mpc=>ts_zc_09_bookingtptype.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    ...
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20211014165207
               iv_uuid              = 'ZC_12_CONNECTIONTP'
